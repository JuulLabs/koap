...
private fun Message.Option.toAdapted(): AdaptedOptions = when (this) {
        ...
        is Message.Option.UriPort -> AdaptedOptions(AdaptedOptions.AdaptedOptionsType.UriPort, port.toString())
        ...
        is Message.Option.ProxyScheme -> AdaptedOptions(AdaptedOptions.AdaptedOptionsType.ProxyScheme, uri)
        is Message.Option.ContentFormat -> AdaptedOptions(AdaptedOptions.AdaptedOptionsType.ContentFormat, format.toString())
        is Message.Option.Accept -> AdaptedOptions(AdaptedOptions.AdaptedOptionsType.Accept, format.toString())
        is Message.Option.MaxAge -> AdaptedOptions(AdaptedOptions.AdaptedOptionsType.MaxAge, seconds.toString())
        is Message.Option.ETag -> AdaptedOptions(AdaptedOptions.AdaptedOptionsType.ETag, etag.decodeToString())
        is Message.Option.LocationPath -> AdaptedOptions(AdaptedOptions.AdaptedOptionsType.LocationPath, uri)
        is Message.Option.LocationQuery -> AdaptedOptions(AdaptedOptions.AdaptedOptionsType.LocationQuery, uri)
        is Message.Option.IfMatch -> AdaptedOptions(AdaptedOptions.AdaptedOptionsType.IfMatch, etag.decodeToString())
        is Message.Option.IfNoneMatch -> AdaptedOptions(AdaptedOptions.AdaptedOptionsType.IfNoneMatch, "")
        is Message.Option.Size1 -> AdaptedOptions(AdaptedOptions.AdaptedOptionsType.Size1, bytes.toString())
        is Message.Option.Observe -> AdaptedOptions(AdaptedOptions.AdaptedOptionsType.Observe, value.toString())
